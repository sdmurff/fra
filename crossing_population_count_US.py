...
from shapely.geometry import Point
  ...
  #data = pd.read_csv("/Users/murff/Downloads/crossings_usa_residential_clean.csv")
  data = pd.read_csv("/Users/murff/Downloads/crossings_usa_clean1.csv")
  ...
  #census_gdf = gpd.read_file("/Users/murff/Downloads/tl_2024_49_tabblock20/tl_2024_49_tabblock20.shp")
  census_gdf = gpd.read_file("/Users/murff/Downloads/US Tabblock/nationwide_tabblock20.gpkg", layer="blocks")
  #census_gdf.drop(columns=["geometry"]).to_csv("/Users/murff/Downloads/tl_2024_49_tabblock20.csv", index=False)
  ...
  crossings_with_blocks.to_csv("/Users/murff/Downloads/crossings_census_join_US1.csv", index=False)
  
  
  # Step 5: Avoid Double Counting by Taking the Maximum Adjusted Population for Each Census Block
  adjusted_population_per_block = crossings_with_blocks.groupby('GEOID20', as_index=False)['adjusted_population'].max()
